class Quantity < ActiveHash::Base
    self.data = [
      ...
      { id: 19, name: '19' }, { id: 20, name: '21' }, { id: 21, name: '21' },
      ...
      { id: 52, name: '52' }, { id: 53, name: '53' }, { id: 54, name: '54' },
      { id: 55, name: '55' }, { id: 56, name: '56' }, { id: 57, name: '57' },
      { id: 58, name: '58' }, { id: 59, name: '59' }, { id: 60, name: '60' },
      { id: 61, name: '61' }, { id: 62, name: '62' }, { id: 63, name: '63' },
      { id: 64, name: '64' }, { id: 65, name: '65' }, { id: 66, name: '66' },
      { id: 67, name: '67' }, { id: 68, name: '68' }, { id: 69, name: '69' },
      { id: 70, name: '70' }, { id: 71, name: '71' }, { id: 72, name: '72' },
      { id: 73, name: '73' }, { id: 74, name: '74' }, { id: 75, name: '75' },
      { id: 76, name: '76' }, { id: 77, name: '77' }, { id: 78, name: '78' },
      { id: 79, name: '79' }, { id: 80, name: '80' }, { id: 81, name: '81' },
      { id: 82, name: '82' }, { id: 83, name: '83' }, { id: 84, name: '84' },
      { id: 85, name: '85' }, { id: 86, name: '86' }, { id: 87, name: '87' },
      { id: 88, name: '88' }, { id: 89, name: '89' }, { id: 90, name: '90' },
      { id: 91, name: '91' }, { id: 92, name: '92' }, { id: 93, name: '93' },
      { id: 94, name: '94' }, { id: 95, name: '95' }, { id: 96, name: '96' },
      { id: 97, name: '97' }, { id: 98, name: '98' }, { id: 99, name: '99' },
      { id: 100, name: '100' },
    ]
